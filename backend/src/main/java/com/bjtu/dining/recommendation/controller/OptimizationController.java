...
public class OptimizationController {
    ...
    @GetMapping("/{taskId}")
    public ApiResponse<OptimizationJobResult> job(@PathVariable String taskId) {
        return ApiResponse.ok(optimizationService.getJob(taskId));
    }

    @GetMapping("/{taskId}/iterations")
    public ApiResponse<List<OptimizationIterationItem>> iterations(@PathVariable String taskId) {
        return ApiResponse.ok(optimizationService.getIterations(taskId));
    }

    @GetMapping("/{taskId}/best")
    public ApiResponse<OptimizationBestResult> best(@PathVariable String taskId) {
        return ApiResponse.ok(optimizationService.getBest(taskId));
    }
}
